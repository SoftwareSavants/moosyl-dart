...
class CustomersApi {
  ...
  Future<Response<CustomerList>> getCustomers({ 
    String? id,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CustomerGet] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CustomerGet>> patchCustomersById({ 
    required String id,
    required CustomerUpdate customerUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CustomerUpdate);
      _bodyData = _serializers.serialize(customerUpdate, specifiedType: _type);
    ...
    CustomerGet? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CustomerGet),
      ) as CustomerGet;
  ...
  /// Returns a [Future] containing a [Response] with a [CustomerGet] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CustomerGet>> postCustomers({ 
    required CustomerCreate customerCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CustomerCreate);
      _bodyData = _serializers.serialize(customerCreate, specifiedType: _type);
