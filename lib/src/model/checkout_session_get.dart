...
part 'checkout_session_get.g.dart';
...
abstract class CheckoutSessionGet implements Built<CheckoutSessionGet, CheckoutSessionGetBuilder> {
  ...
  CheckoutSessionGet._();

  factory CheckoutSessionGet([void updates(CheckoutSessionGetBuilder b)]) = _$CheckoutSessionGet;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CheckoutSessionGetBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CheckoutSessionGet> get serializer => _$CheckoutSessionGetSerializer();
}

class _$CheckoutSessionGetSerializer implements PrimitiveSerializer<CheckoutSessionGet> {
  @override
  final Iterable<Type> types = const [CheckoutSessionGet, _$CheckoutSessionGet];

  @override
  final String wireName = r'CheckoutSessionGet';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CheckoutSessionGet object, {
  ...
  void _deserializeProperties(
    ...
    required CheckoutSessionGetBuilder result,
  ...
  @override
  CheckoutSessionGet deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CheckoutSessionGetBuilder();
